export const objects_3D = {
  ...
  markers: {
    markerYellow: require("./markers/markerYellow.png"),
    markerGreen: require("./markers/markerGreen.png"),
    markerRed: require("./markers/markerRed.png"),
    marker: require("./markers/marker.png"),
  },
};
